        ...
        <div style={{ display: 'flex', height: '100vh', width: 'auto' }}>
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    <nav className="menu">
                        <ul>
                            <li className="active "><a className='menuItem' href="/" >Home</a></li>
                            <li className=" "><a className='menuItem' href="/" >Products</a></li>
                            <li className=" "><a className='menuItem' href="/" >Orders</a></li>                        </ul>
                    </nav>
                </div>
            </aside>
            <main className="main-content">
                <header className="content-header">
                    <div>
                        <button className="menu-toggle"><img src={hamburger} alt='' /></button>
                    </div>
                    <div style={{ display: 'flex', marginLeft: 'auto', paddingRight: '1rem', gap: '1rem' }}>
                        <div className='message-button'><img style={{ width: '24px', aspectRatio: '1/1' }} src={sellersearch} alt='' /></div>
                        <div className='message-button'><img style={{ width: '24px', aspectRatio: '1/1' }} src={sellermessage} alt='' /><span className="message-badge">1</span></div>
                        <div className='message-button'><img style={{ width: '24px', aspectRatio: '1/1' }} src={sellernotification} alt='' /> <span className="notification-badge">1</span></div>
                    ...
                    <div style={{ display: 'flex' }}>
                        <div className='statistic-container'>
                            <div className='change-type-button-container'>
                                <button onClick={() => handleChartTypeChange('line')}>Area Chart</button>
                                <button onClick={() => handleChartTypeChange('doughnut')}>Donut Chart</button>
                            </div>
